...
\cite{tournier_mrtrix:_2012}), the arcana of neuroimaging analysis is substantial due to
...
sufficient informatics support, software-managed repositories (\cite{marcus_extensible_2007}; Das et. al. 2011) can provide additional features, such as
...
readily available in alternative workflow frameworks (\cite{cusack_automatic_2015}; \cite{achterberg_fastr:_2016}; \cite{amstutz_common_2016}), and has been used

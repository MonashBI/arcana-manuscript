...
local workstations that can be deployed on large-scale
...
The framework that Arcana provides should facilitate the development of workflows
that are consistent with the F.A.I.R. guiding principles \citep{wilkinson_fair_2016}.
\begin{itemize}
\item Findable all in one code-base
\item Accessible open source and implemented in different systems
\item Interoperable with BIDS derivatives
\item Interoperable with different analysis software
\item Reusable in different contexts
\item Reusable with detailed provenance
\end{itemize}

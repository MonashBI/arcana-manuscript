...
are implemented as Python classes, which specify a range of potential derivatives and analysis methods.
...
computing environments without alteration. Generic analysis methods can be consolidated within a common
base classes to facilitate code-reuse and collaborative development, which can be specialised for study-specific
requirements via class inheritance. Therefore, Arcana provides a platform to develop unified neuroimaging
workflows that can be reused across many research sites and studies.

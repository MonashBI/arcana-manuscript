...
derivative specification entries can be overridden by input
specification entries, and vice-versa.
...
derivatives \citep{gorgolewski_bids_nodate} to enable interoperability with
other BIDS apps.

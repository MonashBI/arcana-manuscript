...
\begin{figure*}
    \centering
    \includegraphics[width=0.55\textwidth]{example_study}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.9\textwidth]{simplified_arcana_uml}
...
distinguished from derivatives by using the \emph{InputFilesetSpec}
and \emph{InputFieldSpec} subtypes. However, the distinction between
...
\begin{figure}
\lstinputlisting[language=Python,basicstyle=\footnotesize,firstline=2, lastline=59]{example_study.py.txt}
...
\begin{figure}
\lstinputlisting[language=Python, firstline=61, basicstyle=\footnotesize]{example_study.py.txt}
...
\begin{figure*}
  \centering
    \includegraphics[width=0.775\textwidth]{example_multi_study}
...
\begin{figure*}
	\centering
    \includegraphics[width=\textwidth]{full_arcana_uml}
...
\begin{figure}
\lstinputlisting[language=Python, basicstyle=\footnotesize]{example_application.py.txt}
...
dictionary mapping data specification names to \emph{InputFileset} and
\emph{InputField} objects.

InputFileset and InputField objects are required
...
\begin{figure*}
	\centering
    \includegraphics[width=0.55\textwidth]{dwi_study}
...
\begin{figure*}
	\centering
    \includegraphics[width=0.775\textwidth]{t2star_t1_study}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{veins}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{fa_adc}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{tractography}
...
The source code for the Arcana software framework, Banana workflows, and the
code to generate the examples in this manuscript are publicly
available on GitHub at \url{github.com/MonashBI/arcana},
\url{github.com/MonashBI/banana} and
\url{github.com/MonashBI/arcana-manuscript}, respectively. The example data

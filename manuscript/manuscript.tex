...
At the heart of each Study class is the data-specification-table attribute, which
...
associated files, such as field maps and diffusion encoding matrices in reference
...
the subdirectory names. Note that the directory
